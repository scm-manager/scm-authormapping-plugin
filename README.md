...
The authormapping plugin searches for and replaces user names from commits with a specified name and email address.

## Usage

Find out how this plugin can be used on the [user documentation page](https://scm-manager.org/plugins/scm-authormapping-plugin/docs).
